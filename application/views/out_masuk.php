      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="<?php echo base_url('main/masuk')?>">Surat Masuk</a>
            <a class="collapse-item" href="<?php echo base_url('main/keluar')?>">Surat Keluar</a>
          </div>
        </div>
      </li>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo('login/logout')?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
